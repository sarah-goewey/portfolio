        ...
        <div className="carousel-inner">
          ...
          <div className="carousel-item">
            ...
            <div className="row" style={{ width: "75%", margin: "auto" }}>
              ...
              Sirens of Titan. In Sirens, the caves of Mercury are inhabited by
              a primitive species called Harmoniums who can only communicate two
              thoughts: "I am here" and "So glad you are". And isn't this all
              actually want from social media: to announce our presence, and to
